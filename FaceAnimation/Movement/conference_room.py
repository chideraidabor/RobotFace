...
dxl_comm_result, dxl_error = packetHandler.write4ByteTxRx(portHandler, 11, ADDR_GOAL_POSITION, 753)
...
dxl_comm_result, dxl_error = packetHandler.write4ByteTxRx(portHandler, 12, ADDR_GOAL_POSITION, 2309)
...
dxl_comm_result, dxl_error = packetHandler.write4ByteTxRx(portHandler, 14, ADDR_GOAL_POSITION, 1973)
...
dxl_comm_result, dxl_error = packetHandler.write4ByteTxRx(portHandler, 16, ADDR_GOAL_POSITION, 2624)
...
dxl_comm_result, dxl_error = packetHandler.write4ByteTxRx(portHandler, 13, ADDR_GOAL_POSITION, 1865)
...
dxl_comm_result, dxl_error = packetHandler.write4ByteTxRx(portHandler, 15, ADDR_GOAL_POSITION, 2980)
