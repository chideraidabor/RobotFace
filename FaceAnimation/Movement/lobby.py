...
dxl_comm_result, dxl_error = packetHandler.write4ByteTxRx(portHandler, 11, ADDR_GOAL_POSITION, 1517)
...
dxl_comm_result, dxl_error = packetHandler.write4ByteTxRx(portHandler, 12, ADDR_GOAL_POSITION, 2124)
...
dxl_comm_result, dxl_error = packetHandler.write4ByteTxRx(portHandler, 14, ADDR_GOAL_POSITION, 2306)
...
dxl_comm_result, dxl_error = packetHandler.write4ByteTxRx(portHandler, 16, ADDR_GOAL_POSITION, 2145)
...
dxl_comm_result, dxl_error = packetHandler.write4ByteTxRx(portHandler, 13, ADDR_GOAL_POSITION, 2083)
...
dxl_comm_result, dxl_error = packetHandler.write4ByteTxRx(portHandler, 15, ADDR_GOAL_POSITION, 3031)
